...
function validate_date($value)
{
    if (is_date_valid($value)) {
        ...
        $format_diff = date_interval_format($diff, "%R%d");
        if ($format_diff >= 0) {
            return 'Дата должна быть больше текущей не менее чем на два дня. <br>Например, сегодня 16.12.2022 - ставим не ранее 18.12.2022';
        }
    } else {
